...
public class Calc_p2b extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calc_p2b);
        ...
        btn1.setOnClickListener(view -> {
            ...
            ans.setText(getString(R.string.addition_text_p2b) + a);
        });
        ...
        btn2.setOnClickListener(view -> {
            ...
            ans.setText(getString(R.string.subtract_text_p2b) + a);
        });
        ...
        btn3.setOnClickListener(view -> {
            ...
            ans.setText(getString(R.string.multiplication_text_p2b) + a);
        });
        ...
        btn4.setOnClickListener(view -> {
            ...
            ans.setText(getString(R.string.division_text_p2b) + a);
        });
    }
